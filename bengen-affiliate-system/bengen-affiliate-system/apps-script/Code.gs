...
function handleRequest(e) {
  try {
    ...
    switch (action) {
      ...
      // ── n8n Workflow C ──
      case 'getDriveImages':     result = getDriveImages(postData);     break;
...
// ═══════════════════════════════════════════════════════════════
// GET DRIVE IMAGES — ดึงรายการรูปในโฟลเดอร์
// ═══════════════════════════════════════════════════════════════
function getDriveImages(params) {
  ...
  return { imageUrls: images, count: images.length };
}
...
function proxyImage(params) {
  ...
  if (!fileId) throw new Error('ต้องระบุ fileId');
